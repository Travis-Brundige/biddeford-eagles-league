    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True, help_text="Table 1–5 when assigned.", null=True
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Standings / rotation round this result counts toward when it differs from week.number (e.g. a pairing scored as round 14 but anchored to round 13's calendar week).",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("primary_thursday", "Primary league night (Thursday)"),
                            (
                                "makeup_same_week",
                ...
                (
                    "week",
                    models.ForeignKey(
                        help_text="Round row whose calendar week anchors this match (primary Thursday night).",
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["season_team", "effective_from"],
                        name="league_seas_season__e4c5e2_idx",
                    ),
                    models.Index(
                        fields=["player", "effective_from"],
                        name="league_seas_player__9be31b_idx",
                    ),
                ],
                "constraints": [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("season", "team"), name="season_team_unique_per_season"
            ),
        ),
        migrations.AddConstraint(
            model_name="seasonteam",
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("last_week_number__isnull", True),
                    ("last_week_number__gte", models.F("first_week_number")),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            model_name="week",
            constraint=models.UniqueConstraint(
                fields=("season", "number"), name="week_unique_number_per_season"
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ...
                    models.Q(("table_number__gte", 1), ("table_number__lte", 5)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("week", "season_team"), name="bye_unique_team_per_week"
            ),
        ),
    ]
